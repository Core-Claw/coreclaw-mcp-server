...
// doGet performs a single upstream GET for this tool. CoreClaw's list endpoints
// use 1-based page numbering (offset=1 is page 1; offset=0 is accepted as page
// 1), so the MCP layer passes offset/limit straight through without stitching.
...
func offsetParam() v2ParamSpec {
	return v2ParamSpec{
		...
		Type:        v2NumberParam,
		Description: "Page number, 1-based. offset=1 is page 1; offset=0 is accepted as page 1. (default: 1)",
		Default:     1,
		Min:         float64Ptr(0),
	}
}
